  ...
  async run(redirectUri) {
    ...
    while (isProcessed) {
      ...
      if (url.includes(CALLBACK_BLANK)) {
        ...
        const user = params.get('425433519');
        return {
          user: user !== null ? Number(user) : null,
          token: params.get('42129de508cff76ee83c845310f2b5d5d21fc6c992e1e963dfb707169fb576574eb1bf73b504d1aeb8bbd')
        };
      }
